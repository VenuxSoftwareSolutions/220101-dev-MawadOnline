...
class ProductController extends Controller
{
    ...
    //    dd($attributeAvailable) ;
        ...
        if( isset($lastItem['variant_pricing-from']['discount']['date']) && is_array($lastItem['variant_pricing-from']['discount']['date'])){
        ...
        if( isset($data['date_range_pricing']) && is_array($data['date_range_pricing'])){
            // Extract start and end dates from the first date interval
