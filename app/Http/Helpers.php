...
if (!function_exists('shippers_areas')) {
    function shippers_areas($emirate_id,$area_id)
    {
        $shippers_areas = ShippersArea::where('emirate_id',$emirate_id)->where('area_id',$area_id)->get() ;
    }
}
