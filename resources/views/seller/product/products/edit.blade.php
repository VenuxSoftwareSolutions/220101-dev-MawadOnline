                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label" style="padding-top: 12px;">{{translate('Video Provider')}}</label>
                                    <div class="col-md-9">
                            ...
                            <div class="col-6">
                                <div class="form-group row">
                                    <label class="col-md-2 col-from-label" style="padding-top: 12px;">{{translate('Video Link')}}</label>
                                    <div class="col-md-10">
                                    ...
                                    <tbody id="bloc_pricing_configuration">
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td style="width: 19% !important;">
                                                    <div class="col-md-9 input-group">
                                                        <input type="number" class="form-control discount_percentage" name="discount_percentage[]"></td>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                    </div>
