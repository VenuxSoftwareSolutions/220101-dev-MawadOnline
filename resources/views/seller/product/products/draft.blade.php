                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="nameProduct" type="text" class="form-control" name="name" value="{{ $product->name }}" placeholder="{{ translate('Product Name') }}" >
                                    </div>
                                </div>
                            ...
                            <div class="bloc-default-shipping-style" style="margin-top: 22px;">
                                ...
                                <div id="sample_parent">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <input type="number" min="1" step="0.01" class="form-control sample_price_parent" id="sample_price_parent" name="sample_price" value="{{ $product->sample_price }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="sku_product_product" style="margin-left: 7px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-10 mb-3" style="padding-right: 0">
                                        <input type="text" name="product_sk" class="form-control" id="sku_product_parent" value="{{ $product->sku }}" id="product_sk">
                                    </div>
                                </div>
                                <div class="row">
                                    <label class="col-md-2 col-from-label">{{translate('Low stock warning')}}</label>
