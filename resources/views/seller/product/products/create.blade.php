        ...
        <div class="row gutters-5">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" required class="form-control" name="manufacturer" value="{{ old('manufacturer') }}" placeholder="{{translate('Manufacturer')}}" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                ...
                                <div>
                                    <table class="table" id="table_shipping_configuration" class="bloc_shipping_configuration_variant">
                                        ...
                                        <tbody id="bloc_shipping_configuration">
                                            <tr>
                                                <td><input type="number" name="from_shipping[]" class="form-control min-qty-shipping" id="min-qty-shipping" placeholder="{{translate('From QTY') }}"></td>
                                                <td><input type="number" name="to_shipping[]" class="form-control max-qty-shipping" id="max-qty-shipping" placeholder="{{translate('To QTY') }}"></td>
                                                <td>
                                                    ...
                                                    <select class="shipper" name="shipper[0][]"  multiple id="shipper_shipping">
                                                        <option value="vendor" @selected(old('shipper') == 'vendor')>{{translate('vendor')}}</option>
                                                        <option value="third_party" @selected(old('shipper') == 'third_party')>{{translate('MawadOnline 3rd Party Shippers')}}</option>
                                                    </select>
                                                </td>
                                    ...
                                    <table class="table" id="table_sample_configuration" class="bloc_sample_configuration_variant">
                                        ...
                                        <tbody id="bloc_sample_configuration">
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control estimated_sample" id="estimated_sample_parent" name="estimated_sample"></td>
                                                <td><input type="number" disabled class="form-control estimated_shipping_sample" id="estimated_shipping_sample_parent" name="estimated_shipping_sample"></td>
                                                <td>
                                                    <select class="form-control paid_sample" name="paid_sample" id="paid_sample_parent" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                          ...
                                          <label class="custom-file-label" for="inputGroupFile04">{{translate('Choose file') }}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-12">
                <div class="mar-all text-right mb-2">
                    ...
                    <button type="submit" name="button" value="publish" class="btn btn-primary">{{ translate('Create Product') }}</button>
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.btn-add-pricing', function() {
            ...
            if(newvariant != undefined){
                var html_to_add = `<tr>
                                    <td><input type="number" min="1" placeholder="{{translate('From QTY') }}" required name="variant_pricing-from`+ newvariant +`[from][]" class="form-control min-qty" id=""></td>
                                    <td><input type="number" min="1" placeholder="{{translate('To QTY') }}" required name="variant_pricing-from`+ newvariant +`[to][]" class="form-control max-qty" id=""></td>
                                    <td><input type="number" step="0.01" placeholder="{{translate('Unit Price') }}" min="1" required name="variant_pricing-from`+ newvariant +`[unit_price][]" class="form-control unit-price-variant" id=""></td>
                                    ...
                                    <td><input type="number" class="form-control discount_amount" placeholder="{{translate('Amount') }}" name="variant_pricing-from`+ newvariant +`[discount_amount][]" readonly></td>
                                    <td style="width: 19% !important;">
                                        <div class="col-md-9 input-group">
                                            <input type="number" class="form-control discount_percentage" placeholder="{{translate('Percentage') }}" name="variant_pricing-from`+ newvariant +`[discount_percentage][]" readonly>
                                            <div class="input-group-append">
                                                <span class="input-group-text">%</span>
                                            </div>
                                        </div>
                            ...
                            $("#bloc_variants_created div").each(function(index, element) {
                                $(element).find('.attributes').each(function(index, child_element) {
                                    ...
                                    if ($(child_element).attr('type') == 'radio') {
                                        ...
                                        if ((!$(child_element).attr('name').includes(specificString)) && ($(child_element).attr('name') != undefined)) {
                        ...
                        $("#general_attributes div").each(function(index, element) {
                            $(element).find('.attributes').each(function(index, child_element) {
                                ...
                                if ($(child_element).attr('type') == 'radio') {
                                    ...
                                    if(($(child_element).attr('name') != "attribute_generale-undefined") && ($(child_element).attr('name') != undefined)){
                                        if($(child_element).val() == ''){
                                            check_attributes_generale_empty = false;
                                        }
                                    }
