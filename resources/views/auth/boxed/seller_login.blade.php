                        ...
                        <div class="col-lg-6 p-4 p-lg-5 d-flex flex-column justify-content-center border right-content" style="height: auto;">
                            ...
                            <div class="pt-3">
                                <div class="">
                                    ...
                                    <form class="form-default" id="login_form" role="form" action="{{ route('seller.login_seller') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" required class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} rounded-0" value="{{ old('email') }}" placeholder="{{  translate('johndoe@example.com') }}" name="email" id="email" autocomplete="off">
                                            @if ($errors->has('email'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                <input type="password" required class="form-control rounded-0 {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ translate('Password')}}" name="password" id="password">
                                        ...
                                        <div class="form-group">
                                            <label for="password" class="fs-12 fw-700 text-soft-dark">{{ translate('Otp code') }}</label>
                                            <div class="position-relative">
                                                <input type="text" class="form-control rounded-0 {{ $errors->has('otp_code') ? ' is-invalid' : '' }}" placeholder="{{ translate('OTP code')}}" name="otp_code" id="otp_code">
