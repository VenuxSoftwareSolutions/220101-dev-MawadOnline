...
<head>
    ...
    <title>Order {{$order->delivery_status == "picked_up" ? "Picked Up" : "On the Way"}}</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img src="{{ asset('public/uploads/all/CxeI3PF3NMzjzHp6Ct3xf8dPS1q2pFYmwAwbHQii.png') }}" alt="Logo">
                  ...
                  <p>order ref {{$order->order->code}} received on {{$order->created_at->format("Y-m-d H:m:s")}} is {{$order->delivery_status == "picked_up" ? "Picked Up" : "On the Way"}}. </p>
