...
<head>
    ...
    <style>
        :root {
            --primary-blue: #3D3D3B ;    /* Trustworthy navy blue */
            --action-orange: #FF6B35;   /* Vibrant safety orange */
            --success-green: #2A9D8F;   /* Construction teal */
            --background-gray: #F8F9FA; /* Light background */
        ...
        <div class="verification-card">
            <h2 style="color: var(--primary-blue); margin-top: 0; font-size: 20px;">
                <svg xmlns="http://www.w3.org/2000/svg" 
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 3l7.5 4.5v5.25a8.25 8.25 0 01-5.63 7.79l-.87.28a.75.75 0 01-.5 0l-.87-.28A8.25 8.25 0 014.5 12.75V7.5L12 3z" />
            ...
            <p style="color: var(--text-dark); line-height: 1.6;">
                ...
                To activate your vendor account and start reaching customers worldwide, please enter this verification code:
            </p>
            ...
            <div style="background: #FFF9F7; padding: 20px; border-radius: 6px; border-left: 4px solid var(--action-orange); display: flex; align-items: flex-start;">
                ...
                <p style="color: var(--text-dark); margin: 0; font-size: 14px;">
                    <strong>Next Step:</strong> After verification, you'll complete your business profile to start showcasing your construction materials/services.
                </p>
            </div>
                ...
                <td style="padding: 0 10px;">
                    <a href="{{ get_setting('twitter_link') }}" target="_blank" style="display: block;">
                        <svg width="24" height="24" viewBox="0 0 27 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill="#FFFFFF" d="M21.253 0.266602H25.3734L16.3734 10.4533L26.9999 24.2666H18.6505L12.1445 15.8933L4.66259 24.2666H0.542108L10.1927 13.3866L-6.10352e-05 0.266602H8.5662L14.4758 7.9466L21.253 0.266602ZM19.7891 21.8133H22.0662L7.31922 2.55994H4.82524L19.7891 21.8133Z"/>
                        </svg>
                    </a>
                </td>
                @endif
