            ...
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="approved_at" name="approved_at" value="{{ $brand->approved_at ?? translate('Not Approved Yet') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="approved_by" name="approved_by" value="{{ optional($brand->approvedUser)->name  ?? translate('Not Approved Yet') }}" class="form-control" disabled>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="confirmationButton">{{ translate('Yes') }}</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
        ...
        $('#status').on('change', function () {
            if ($(this).is(':checked')) {
                ...
                $('#confirmModalBody').text("{{ translate('Are you sure you want to approve this brand?') }}");
                ...
                $('#confirmModalBody').text("{{ translate('Are you sure you want to disapprove this brand?') }}");
