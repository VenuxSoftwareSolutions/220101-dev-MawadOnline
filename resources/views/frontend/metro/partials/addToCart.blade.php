                            ...
                            <div class="col-9">
                                <div class="product-quantity d-flex align-items-center">
                                    <div class="row no-gutters align-items-center aiz-plus-minus mr-3"
                                        style="width: 130px;">
                                        <button
                                            class="btn col-auto btn-icon btn-sm btn-light rounded-0 quantity-control"
                                            type="button" data-type="minus" data-field="quantity" disabled="">
                                            <i class="las la-minus"></i>
                                        </button>
                                        <input id="quantity" readonly type="number" name="quantity"
                        ...
                        <div class="col-9">
                            <div class="product-price">
                                <strong id="chosen_price" class="fs-20 fw-700 text-primary">
                                    {{ $previewData['detailedProduct']['totalDiscount'] ?? $previewData['detailedProduct']['total'] }}
                                    AED
                                </strong>
                            </div>
                        </div>
