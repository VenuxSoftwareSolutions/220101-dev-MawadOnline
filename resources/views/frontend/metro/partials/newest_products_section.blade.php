        ...
        <div class="container">
            ...
            <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between px-1">
                ...
                <h3 class="fs-20 mb-2 mb-sm-0">
                    <span class="font-prompt-md">{{ translate('Recently Added') }}</span>
                </h3>
                <!-- Links -->
                <div class="d-flex">
            ...
            <div class="px-sm-3">
                <div class="aiz-carousel arrow-none sm-gutters-16" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='false'>
                    ...
                    <div class="carousel-box px-2 position-relative has-transition border-right border-top border-bottom @if($key == 0) border-left @endif hov-animate-outline">
                        @include('frontend.'.get_setting('homepage_select').'.partials.product_box_1', [
                            'product' => $new_product,
                            "mwd_price" => calculatePriceWithDiscountAndMwdCommission($new_product)
                        ])
                    </div>
                    @endforeach
                </div>
