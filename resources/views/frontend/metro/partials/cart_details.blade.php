                                ...
                                <li class="list-group-item px-0">
                                    <div class="row gutters-5 align-items-center">
                                        ...
                                        <div class="col-md-5 d-flex align-items-center mb-2 mb-md-0">
                                            ...
                                            <span class="fs-14">{{ isset($data[$key]["is_sample"]) && $data[$key]["is_sample"] === true ? __("Sample of") . " " . $data[$key]["product_name_with_choice"] : $data[$key]["product_name_with_choice"] }}</span>
                                        </div>
                                        <!-- Stock Status -->
