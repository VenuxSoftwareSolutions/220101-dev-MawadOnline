<section class="py-3 text-light footer-widget border-bottom subscription-icons__clz"
    style="border-color: #3d3d46 !important; background-color: #3D3D3B !important;">
    <div class="container">
            ...
            <div class="col-xl-6 col-lg-12">
                ...
                <div class="col-xxl-6 col-xl-8 col-lg-8 p-0">
                                            ...
                                            <defs>
                                                <clipPath id="clip0_5007_1600">
                                                    <rect width="27" height="24" fill="white"
                                                        transform="translate(-6.10352e-05 0.266602)" />
                                                </clipPath>
                                            </defs>
                                        </svg>
                                    ...
                                    <a href="{{ get_setting('youtube_link') }}" target="_blank">
                                        <svg width="32" height="33" viewBox="0 0 32 33" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_5007_1611)">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M28.502 5.92341C29.8789 6.28481 30.9631 7.34968 31.3311 8.70197C31.9998 11.1529 31.9998 16.2666 31.9998 16.2666C31.9998 16.2666 31.9998 21.3802 31.3311 23.8314C30.9631 25.1835 29.8789 26.2484 28.502 26.6099C26.0066 27.2666 15.9998 27.2666 15.9998 27.2666C15.9998 27.2666 5.99317 27.2666 3.49765 26.6099C2.12087 26.2484 1.03649 25.1835 0.668526 23.8314C-0.000152588 21.3802 -0.000152588 16.2666 -0.000152588 16.2666C-0.000152588 16.2666 -0.000152588 11.1529 0.668526 8.70197C1.03649 7.34968 2.12087 6.28481 3.49765 5.92341C5.99317 5.2666 15.9998 5.2666 15.9998 5.2666C15.9998 5.2666 26.0066 5.2666 28.502 5.92341ZM20.9998 16.7668L12.9998 21.2666V12.2666L20.9998 16.7668Z"
                                                    fill="#A2A4AD" />
                                            </g>
                                            <defs>
                    ...
                    @if (get_setting('play_store_link') != null || get_setting('app_store_link') != null)
                        <h5 class="fs-14 fw-700 text-secondary text-uppercase mt-3">{{ translate('Mobile Apps') }}
                        </h5>
                ...
                <div class="{{ $col_values }} float-left my-3">
                    <div class="text-center text-sm-left mt-4">
                        ...
                        <ul class="list-unstyled">
                            @if (Auth::check())
                                <li class="mb-2">
                                    <a class="fs-13 text-secondary animate-underline-white"
                                        href="{{ route('logout') }}">
                                        {{ translate('Logout') }}
                                    </a>
                                </li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 float-left my-3 ml-4">
                        <div class="text-center text-sm-left mt-4">
                            ...
                            @if (get_setting('vendor_system_activation') == 1)
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    @if (get_setting('seller_app_link'))
                                        <li class="mb-2">
                                            <a class="fs-13 text-secondary animate-underline-white" target="_blank"
                            ...
                            @if (addon_is_activated('delivery_boy'))
                                <h4 class="fs-14 text-white text-uppercase fw-700 mt-4 mb-3">
...
<section class="py-lg-3 text-light footer-widget footer-accordion-widget__clz" style="background-color: #3D3D3B !important;">
    <div class="container d-none d-lg-block">
        <div class="row">
            <div class="col-12 col-md-6">
                <h5 class="fs-14 fw-700 mt-1 mb-3 font-prompt" style="color:#CB774B;">
    ...
    <div class="d-xl-none bg-transparent">
        ...
        @if (get_setting('vendor_system_activation') == 1)
            <div class="aiz-accordion-wrap bg-black">
                <div class="aiz-accordion-heading container bg-black">
                    <button
                        class="aiz-accordion fs-14 text-white bg-transparent">{{ translate('Vendor Center') }}</button>
                </div>
                <div class="aiz-accordion-panel bg-transparent" style="background-color: #3D3D3B !important;">
                    <div class="container">
                        <ul class="list-unstyled mt-3">
    ...
    <div class="container">
        <div class="row align-items-center py-3">
            ...
            <div class="col-lg-6 order-1 order-lg-0">
                <div class="text-center text-lg-left fs-16 font-prompt" style="font-weight:thin;"
            ...
            <div class="col-lg-6 mb-4 mb-lg-0">
                <span class="fs-14 font-prompt" style="color: #7E808A;">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M12.5 13.6968C14.2231 13.6968 15.62 12.2999 15.62 10.5768C15.62 8.85366 14.2231 7.45679 12.5 7.45679C10.7769 7.45679 9.38 8.85366 9.38 10.5768C9.38 12.2999 10.7769 13.6968 12.5 13.6968Z"
                            stroke="#F3F4F5" stroke-width="1.5" />
                        <path
                            d="M4.12 8.75685C6.09 0.096848 18.92 0.106848 20.88 8.76685C22.03 13.8468 18.87 18.1468 16.1 20.8068C14.09 22.7468 10.91 22.7468 8.89 20.8068C6.13 18.1468 2.97 13.8368 4.12 8.75685Z"
                            stroke="#F3F4F5" stroke-width="1.5" />
                    </svg>
                ...
                <span class="fs-14 font-prompt ml-2" style="color: #7E808A;">
                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M17.5 20.7668H7.5C4.5 20.7668 2.5 19.2668 2.5 15.7668V8.76685C2.5 5.26685 4.5 3.76685 7.5 3.76685H17.5C20.5 3.76685 22.5 5.26685 22.5 8.76685V15.7668C22.5 19.2668 20.5 20.7668 17.5 20.7668Z"
                            stroke="#F3F4F5" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <path d="M17.5 9.26685L14.37 11.7668C13.34 12.5868 11.65 12.5868 10.62 11.7668L7.5 9.26685"
                            stroke="#F3F4F5" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom border-top border-sm-bottom border-sm-left border-sm-right mx-auto mb-sm-2"
    style="background-color:#3D3D3B !important;">
