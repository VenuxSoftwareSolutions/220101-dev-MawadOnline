        ...
        <div class="d-none d-lg-block position-relative background-header h-50px">
            <div class="container h-100">
                <div class="d-flex h-100">
                    ...
                    <button class="scroll-left btn btn-link top-50 translate-middle-y">
                    ...
                    <button class="scroll-right btn btn-link top-50 translate-middle-y">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    function updateArrowVisibility() {
        ...
        // Log clientWidth to the console
