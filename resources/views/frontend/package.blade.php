                        ...
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="text-center mb-4 mt-3">
                                    <h5 class="mb-1 h5 fw-600">{{ $seller_package->getTranslation('name') }}</h5>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-center">
                                    ...
                                    @else
                                        <span
                                            class="fs-32 fw-700 lh-1 mb-0">AED {{ $seller_package->amount }} / month</span>
                                    @endif
                                    {{-- <span
                                ...
                                <div class="text-center">
                                    ...
                                    @else
                                        @if (addon_is_activated('offline_payment'))
                                            <button class="btn btn-primary fw-600"
                                                onclick="select_package({{ $seller_package->id }})">{{ translate('Purchase Package') }}</button>
                                        @else
                                            <button class="btn btn-primary fw-600"
                                    ...
                                    @endif --}}
                                    <button class="btn btn-primary fw-600"
                                                onclick="select_package({{ $seller_package->id }})">{{ translate('Register your e-shop') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
