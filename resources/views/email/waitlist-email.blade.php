...
<body>
    ...
    <main>
        <section class="slider"
            ...
            <div class="content-slider">
                ...
                <div class="buttons-slider">
                    ...
                    <a class="btn2-slider"
                        href="https://calendar.google.com/calendar/u/0/appointments/schedules/AcZssZ3j7k5dpUNzwV6JhvPr0EElvJcamwSmLmP7f26wHhAUcUz6OvvodIwqPtjij8Vx3uybYawSDA8Z "
                        target="_blank">
        ...
        <section id="why-mawad" class="why-MawadOnline">
            ...
            <div class="blocs-section2">
                <div class="bloc1">
                    ...
                    <div class="box">
                        ...
                        <div class="content-box">
                            ...
                            <div class="p-box">Stop wasting time navigating through hundreds of websites.</div>
                        </div>
                    </div>
                    <div class="box">
                ...
                <div class="bloc1">
                    ...
                    <div class="box">
                        <div class="icon-box"><img src="{{ asset('public/home_page/images/transactions.svg') }}">
                        </div>
                        <div class="content-box">
                    ...
                    <div class="bloc1-section3">
                        <div class="bloc1-left">
                            <div class="content-bloc1-left">
                                ...
                                <div class="p-bloc1-left">Choose the products an quantities that align with your
                                    project
                                    requirements</div>
                            </div>
                            <div class="image-bloc1-left">
        ...
        <form action="{{ route('send-waitlist-email') }}#waitlist" method="post">
            @csrf
                            ...
                            <div class="bloc-left-section5">
                                ...
                                <div class="form-left-section5">
                                    ...
                                    <div class="champ2">
                                        ...
                                        <textarea id="info" placeholder="Comments" name="info">{{ old('info') }}</textarea>
                                        @error('info')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
