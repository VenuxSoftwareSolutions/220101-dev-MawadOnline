...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'link'                  => ' ',
        'slug'                  => ' ',
        'trade_name_english' => 'اسم التجارة بالإنجليزية',
        'trade_name_arabic' => 'اسم التجارة بالعربية',
        'trade_license_doc' => 'وثيقة رخصة التجارة',
        'eshop_name_english' => 'اسم المتجر الإلكتروني بالإنجليزية',
        'eshop_name_arabic' => 'اسم المتجر الإلكتروني بالعربية',
        'eshop_desc_en' => 'وصف المتجر الإلكتروني بالإنجليزية',
        'eshop_desc_ar' => 'وصف المتجر الإلكتروني بالعربية',
        ...
        'trn' => 'الرقم الضريبي',
        'tax_waiver' => 'وثيقة إعفاء ضريبي',
        'civil_defense_approval' => 'موافقة الدفاع المدني',
        'first_name' => 'الاسم الأول',
        'last_name' => 'اسم العائلة',
        'email' => 'البريد الإلكتروني',
        'mobile_phone' => 'الهاتف المحمول',
        'additional_mobile_phone' => 'هاتف محمول إضافي',
        'nationality' => 'الجنسية',
        'date_of_birth' => 'تاريخ الميلاد',
        'emirates_id_number' => 'رقم هوية الإمارات',
        'emirates_id_expiry_date' => 'تاريخ انتهاء هوية الإمارات',
        'emirates_id_file' => 'ملف هوية الإمارات',
        'business_owner' => 'صاحب العمل',
        'designation' => 'المسمى الوظيفي',
        'warehouse_name.*' => 'اسم المستودع',
        'state_warehouse.*' => 'إمارة المستودع',
        'area_warehouse.*' => 'منطقة المستودع',
        'street_warehouse.*' => 'شارع المستودع',
        'building_warehouse.*' => 'مبنى المستودع',
        'unit_warehouse.*' => 'وحدة المستودع',
        'bank_name' => 'اسم البنك',
